        ...
        public List<SControlModel> GetAllMainControlInMenu()
        {
            ...
            if (roleControls != null && roleControls.GuidRole != null)
            {
                models = (from frc in DataGemini.FRoleControlMenus
                          ...
                          join fcm in DataGemini.FControlMenus on frc.GuidControl equals fcm.GuidControl
                          where frc.GuidRole == roleControls.GuidRole && ec.Type == "MAIN_CONTROL" && (fcm.GuidMenu == guidMenu || guidMenu == Guid.Empty)
        ...
        public List<SControlModel> GetAllEditControlInMenu()
        {
            ...
            if (roleControls != null && roleControls.GuidRole != null)
            {
                models = (from frc in DataGemini.FRoleControlMenus
                          ...
                          join ec in DataGemini.SControls on frc.GuidControl equals ec.Guid
                          join fcm in DataGemini.FControlMenus on frc.GuidControl equals fcm.GuidControl
                          where frc.GuidRole == roleControls.GuidRole && ec.Type == "EDIT_CONTROL" && (fcm.GuidMenu == guidMenu || guidMenu == Guid.Empty)
                          select new SControlModel()
                          {
                              Guid = ec.Guid,
                              Name = ec.Name,
        ...
        public List<SControlModel> GetAllTabControlInMenu()
        {
            ...
            if (roleControls != null && roleControls.GuidRole != null)
            {
                models = (from frc in DataGemini.FRoleControlMenus
                          ...
                          join ec in DataGemini.SControls on frc.GuidControl equals ec.Guid
                          join fcm in DataGemini.FControlMenus on frc.GuidControl equals fcm.GuidControl
                          where frc.GuidRole == roleControls.GuidRole && ec.Type == "TABS_CONTROL" && (fcm.GuidMenu == guidMenu || guidMenu == Guid.Empty)
                          select new SControlModel()
                          {
                              Guid = ec.Guid,
                              Name = ec.Name,
